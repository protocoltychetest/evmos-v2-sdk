...
import { ChainId, CurrencyAmount, sqrt, Token, Price, wrappedCurrency, currencyEquals, TradeType, Fraction, wrappedCurrencyAmount, computePriceImpact, sortedInsert, validateAndParseAddress } from '@uniswap/sdk-core';
import invariant from 'tiny-invariant';
import { keccak256, pack } from '@ethersproject/solidity';
import { getCreate2Address } from '@ethersproject/address';

var _FACTORY_ADDRESS;
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.EVMOS_TESTNET] = '0x1279aF64A33138792395B16832F9C0fa6F068FCa', _FACTORY_ADDRESS[ChainId.ZKSYNC_TESTNET] = '0x59E5Dd8C2252250d643D010ba438327e7c430FA3', _FACTORY_ADDRESS); // Tyche Factory on TestNet of EVMOS
var INIT_CODE_HASH = '0xd1c22c9265a6b299435d450062fe36d684a63bd3c86362640d444d20b3f90701';
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'TCHLP', 'Tyche LPs');
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var etherOut = trade.outputAmount.currency.isEther;
